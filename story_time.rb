...
#{cur(pretax_value_of_all_grants)} at a share price of $#{StockOptionGrant::EXERCISE_TIME_FMV}."
...
shares. Immediately after exercise, these shares will have a pretax value of #{cur(value_of_exercised_and_held_shares)} at an FMV of $#{StockOptionGrant::EXERCISE_TIME_FMV}, 
