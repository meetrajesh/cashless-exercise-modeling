...
GRANTS = [
  ...
  StockOptionGrant.new(type: StockOptionGrant::OPTION_TYPES.nso, strike: 4.55, num_options: 3_535),
  ...
  StockOptionGrant.new(type: StockOptionGrant::OPTION_TYPES.iso, strike: 10.43, num_options: 405),
